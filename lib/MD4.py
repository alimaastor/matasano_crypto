'''Copied from https://gist.github.com/tristanwietsma/5937448'''
...
class MD4:
    ...
    @staticmethod
    def get_state_from_hex_str(hex_str):
        assert len(hex_str) == 32
        res = []
        for i in xrange(0, 32, 8):
            res.append(int(hex_str[i:i+8], 16))
        return res
...
if __name__ == '__main__':
    ...
    assert MD4.get_state_from_hex_str('31d6cfe0d16ae931b73c59d7e0c089c0') == [836161504, 3513444657, 3074185687, 3770714560]
