...
def log_in_with_A_set_to_zero(sock):
...
def log_in_with_A_set_to_N(sock):
    # C & S: Agree on N=[NIST Prime], g=2, k=3, I (email), P (password)
    N = 
    g = 2
    k = 3
...
def log_in_with_A_set_to_N_square(sock):
    # C & S: Agree on N=[NIST Prime], g=2, k=3, I (email), P (password)
    N = 
    g = 2
    k = 3
...
def log_loop_with_A_set_to_zero(args):
    # Start server.
    ...
    print ""
    try:
        log_in_with_A_set_to_zero(sock)
    finally:
        sock.shutdown(socket.SHUT_RDWR)

def log_loop_with_A_set_to_N(args):
    # Start server.
    print "Starting the server ..."
    server_path = os.path.join('lib', 'srp_server.py')
    server_logfile = os.path.join("/tmp", "srp_server.log")
    ...
    print ""
    try:
        log_in_with_A_set_to_N(sock)
    finally:
        print "Shutting down socket"
        sock.shutdown(socket.SHUT_RDWR)

def log_loop_with_A_set_to_N_square(args):
    # Start server.
    print "Starting the server ..."
    server_path = os.path.join('lib', 'srp_server.py')
    server_logfile = os.path.join("/tmp", "srp_server.log")
    ...
    print ""
    try:
        log_in_with_A_set_to_N_square(sock)
    finally:
        sock.shutdown(socket.SHUT_RDWR)

def main(args):
    print "*" * 70
    log_loop_with_A_set_to_zero(args)
    print "*" * 70
    log_loop_with_A_set_to_N(args)
    print "*" * 70
    log_loop_with_A_set_to_N_square(args)
    print "*" * 70
